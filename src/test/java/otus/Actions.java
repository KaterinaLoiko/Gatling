...
public class Actions {
  ...
  public static ChainBuilder searchFlightsScenario =
      exec(http("Flight Selection Page")
          ...
          .exec(http("Create Flights Request")
          ...
          .exec(http("Reserve Flight")
              ...
              .formParam("reserveFlights", "Reserve Flights")
              .check(status().is(200))
              .check(css("input[name='outboundFlight']", "value").saveAs("outboundFlightFromPayment"))
          );
  ...
  public static ChainBuilder paymentScenario = exec(
      http("Buy Flights")
          ...
          .formParam("pass1", "Ekaterina Loiko")
          ...
          .formParam("seatType", "Coach")
          .formParam("seatPref", "None")
          .formParam("outboundFlight", "#{outboundFlightHidden}")
          .formParam("advanceDiscount", "0")
